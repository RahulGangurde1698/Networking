                    ...
                    <div className="p-2">
                        <div className="text-gray-300 my-3">
                            <p className="text-justify leading-7 w-11/12 mx-auto text-black">
                                My name is Rahul Gangurde and I have completed Network Engineering.Done graduation in bacholor of engineering  with 7.64 CGPA .
                            </p>
                              ...
                              <p className="text-black"> Contact no.  : 9766882803</p>
